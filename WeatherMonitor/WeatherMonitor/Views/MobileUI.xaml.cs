...
public partial class MobileUI : ContentPage
{
	public MobileUI()
	{
		InitializeComponent();
    ...
    {
        GaugeLabelStyle labelStyle = new() { FontSize = 12, FontFamily = "Sen", TextColor = Color.FromArgb("#4FACFE"), FontAttributes = FontAttributes.Bold };
